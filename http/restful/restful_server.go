...
func (this *restServer) registryRestServerAction(web Web) {
	...
	postMethodMap := map[string]Action{
		...
		common.IFLIQUIDATION: {name: common.ACTION_IFLIQUIDATION, handler: web.IFLiquidation},
	}
	getMethodMap := map[string]Action{
		...
		common.IFPOOLDETAIL:                {name: common.ACTION_IFPOOLDETAIL, handler: web.IfPoolDetail},
